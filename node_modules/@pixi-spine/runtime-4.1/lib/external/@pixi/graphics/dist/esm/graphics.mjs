import { BaseTexture, BatchDrawCall, BatchTextureArray, BatchGeometry, Texture, UniformGroup, Shader, State } from '../../../core/dist/esm/core.mjs';
import { SHAPES, Polygon, PI_2, Rectangle, RoundedRectangle, Circle, Ellipse, Matrix, Point } from '../../../math/dist/esm/math.mjs';
import { hex2rgb, premultiplyTint } from '../../../utils/dist/esm/utils.mjs';
import { WRAP_MODES, DRAW_MODES, BLEND_MODES } from '../../../constants/dist/esm/constants.mjs';
import { Container, Bounds } from '../../../display/dist/esm/display.mjs';
import { exports as earcutExports } from '../../../../../_virtual/earcut.mjs';
...
var buildPoly = {
    ...
    triangulate: function (graphicsData, graphicsGeometry) {
        ...
        if (points.length >= 6) {
            ...
            // sort color
            var triangles = earcutExports(points, holeArray, 2);
            if (!triangles) {
                return;
            }
...
var buildRoundedRectangle = {
    ...
    triangulate: function (graphicsData, graphicsGeometry) {
        ...
        var triangles = earcutExports(points, null, 2);
...
export { FillStyle, GRAPHICS_CURVES, Graphics, GraphicsData, GraphicsGeometry, LINE_CAP, LINE_JOIN, LineStyle };
