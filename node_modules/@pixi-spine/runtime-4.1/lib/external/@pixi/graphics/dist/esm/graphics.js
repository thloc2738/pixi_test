...
var core = require('../../../core/dist/esm/core.js');
...
var display = require('../../../display/dist/esm/display.js');
var earcut = require('../../../../../_virtual/earcut.js');
require('../../../../earcut/src/earcut.js');
...
var buildPoly = {
    ...
    triangulate: function (graphicsData, graphicsGeometry) {
        ...
        if (points.length >= 6) {
            ...
            // sort color
            var triangles = earcut.exports(points, holeArray, 2);
            if (!triangles) {
                return;
            }
...
var buildRoundedRectangle = {
    ...
    triangulate: function (graphicsData, graphicsGeometry) {
        ...
        var triangles = earcut.exports(points, null, 2);
