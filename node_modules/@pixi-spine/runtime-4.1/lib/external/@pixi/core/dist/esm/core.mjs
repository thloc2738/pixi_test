import { settings, isMobile } from '../../../settings/dist/esm/settings.mjs';
import { ENV, ALPHA_MODES, SCALE_MODES, FORMATS, TYPES, TARGETS, MIPMAP_MODES, BUFFER_BITS, MSAA_QUALITY, MASK_TYPES, RENDERER_TYPE, BUFFER_TYPE, CLEAR_MODES, DRAW_MODES, PRECISION, BLEND_MODES, GC_MODES, SAMPLER_TYPES, WRAP_MODES } from '../../../constants/dist/esm/constants.mjs';
import { isPow2, BaseTextureCache, TextureCache, uid, determineCrossOrigin, getResolutionOfUrl, deprecation, ProgramCache, hex2string, hex2rgb, isWebGLSupported, premultiplyBlendMode, premultiplyTint, getBufferType, removeItems, sayHello, log2, nextPow2 } from '../../../utils/dist/esm/utils.mjs';
import { extensions, ExtensionType } from '../../../extensions/dist/esm/extensions.mjs';
import { Runner } from '../../../runner/dist/esm/runner.mjs';
import { Ticker } from '../../../ticker/dist/esm/ticker.mjs';
import { Rectangle, Point, Matrix, groupD8 } from '../../../math/dist/esm/math.mjs';
import EventEmitter from '../../../utils/external/eventemitter3/index.mjs';
